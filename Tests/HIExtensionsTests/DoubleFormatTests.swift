...
final class DoubleFormatTests: XCTestCase {
    func testCurrencyDisplayFormatting() {
        XCTAssertEqual(1234567.50.format(with: .currencyDisplay), "$1,234,567.50")
        XCTAssertEqual((-1234567.50).format(with: .currencyDisplay), "-$1,234,567.50")
    }
    
    func testCurrencyInputFormatting() {
        XCTAssertEqual(1234567.89.format(with: .currencyInput), "$1,234,567.89")
    }
    ...
    func testNumberFormatting() {
        XCTAssertEqual(1234567.89.format(with: .number), "1,234,567.89")
    }
    ...
    func testStandardFormatting() {
        XCTAssertEqual(1234567.89.format(with: .standard), "1,234,567.88999999")
    }
}
